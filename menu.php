...
<body>
  ...
  <div class="navmenu">
        ...
        <div class="up";>
			<h1 id="h1">
				&nbsp;<?php echo "Welcome " . $_SESSION['_user']; ?>&nbsp;
			</h1>
    ...
    <div class="container-contact2-form-btn">
        <div class="wrap-contact2-form-btn">
            ...
            <button class="contact2-form-btn" id="myyButton" type="submit" name="login-btns" data-toggle="tooltip" data-placement="top" title="View Cart">
            View Cart
            </button>

            <script type="text/javascript">
                document.getElementById("myyButton").onclick = function () {
                    location.href = "cart.php?id=<?php echo $_SESSION['ids'] ?>";
                }
            ...
            <script type="text/javascript">
                document.getElementById("myButton2").onclick = function () {
                    location.href = "orderform.php?id=<?php echo $_SESSION['ids']?>";
                }
            </script>
